...
class MedicoRepositoryTest {
    ...
    void seleccionarMedicoPorEspecialidadEnFechaEscenario1() {
        ...
        var medico = registrarMedico("Jose","jose@email","114256",Especialidad.CARDIOLOGIA);
        var paciente = registrarPaciente("Antonio","antonio@email","321423");

        registrarConsulta(medico, paciente, proximoLunes10H);

        var medicoLibre = repository.seleccionarMedicoPorEspecialidadEnFecha(Especialidad.CARDIOLOGIA,proximoLunes10H);

        assertThat(medicoLibre).isNull();
    }

    @Test
    @DisplayName("Deberia retornar nulo cuando realice la consulta en la base de datos para ese horario")
